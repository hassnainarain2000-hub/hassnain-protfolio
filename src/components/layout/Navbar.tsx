            ...
            {navLinks.map((link) => (
              ...
              >
                {activeSection === link.href && (
                  <motion.span
                    layoutId="activeNav"
                    className="absolute inset-0 bg-[#2563EB]/10 rounded-lg border border-[#2563EB]/20"
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 py-3 px-4 rounded-xl bg-[#2563EB] text-base font-semibold text-center"
              >
