            ...
            {navLinks.map((link) => (
              ...
              >
                {activeSection === link.href && (
                  <motion.span
                    layoutId="activeNav"
                    className="absolute inset-0 bg-[#8B1E3F]/10 rounded-lg border border-[#8B1E3F]/20"
          ...
          >
            <div className="flex flex-col gap-2">
              {navLinks.map((link) => (
                <a
                  ...
                  className={`py-3 px-4 rounded-xl text-lg font-medium transition-all ${
                    activeSection === link.href
                      ? "bg-[#8B1E3F]/10 text-[#8B1E3F] border border-[#8B1E3F]/20"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 py-3 px-4 rounded-xl bg-[#8B1E3F] text-base font-semibold text-center"
              >
