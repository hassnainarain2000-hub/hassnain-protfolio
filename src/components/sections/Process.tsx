            ...
            {processSteps.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-[#DC2626] text-base font-sora font-bold text-sm flex items-center justify-center">
                    {step.step}
                  </div>
